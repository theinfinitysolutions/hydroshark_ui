            ...
            <div className=" flex flex-row justify-between w-full lg:w-[45%] h-[50vh] lg:h-[60vh] relative overflow-hidden">
              ...
              <div className=" flex w-1/2 h-full bg-[#102914] flex-col items-start px-4 justify-center">
                ...
                <p className=" text-[#dee2e6]/80 text-sm lg:text-base mt-4">
                  {
                    "Hydroshark Lemon, experience the invigorating burst of citrus that not only quenches your thirst but also revitalizes your mind and body. Enjoy the crisp, clean taste that hydrates you with essential vitamins, minerals, and electrolytes, ensuring you stay at your best all day long."
                  }
                </p>
              </div>
