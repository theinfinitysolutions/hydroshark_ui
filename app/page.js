...
export default function Home() {
  ...
  return (
    <Transition>
      <div
        ref={ref}
        className='flex min-h-screen h-full bg-[#f0f2f4]  w-[100vw] z-20 flex-col overflow-hidden relative items-center '
      >
        <div className=' h-[10vw] w-[10vw] lg:h-[8vh] lg:w-[8vh] absolute right-[80vw] lg:right-[10vw] top-[45vh] lg:top-[50vh] animate-rotate -mt-2 '>
          <Image src={process.env.NEXT_PUBLIC_API_URL + '/asset5.png'} alt='asset5' fill />
        </div>
        <div className='absolute overflow-hidden flex flex-row  bg-black rotate-[7deg] lg:rotate-[4deg] top-[75vh] z-30  '>
          ...
          >
            ...
            <span className=' text-[8px] lg:text-[12px] p-[1vw_2vw] lg:p-[0_2vw] text-white'>{'Low calorie'}</span>
            <span className='h-1 w-1 lg:h-2 lg:w-2 rounded-full bg-white'></span>
            <span className='text-[8px] lg:text-[12px] p-[1vw_2vw] lg:p-[0_2vw] text-white'>{'Low sugar'}</span>
            <span className='h-1 w-1 lg:h-2 lg:w-2 rounded-full bg-white'></span>
            <span className='text-[8px] lg:text-[12px] p-[1vw_2vw] lg:p-[0_2vw] text-white'>{'Electrolytes'}</span>
            <span className='h-1 w-1 lg:h-2 lg:w-2 rounded-full bg-white'></span>
            <span className='text-[8px] lg:text-[12px] p-[1vw_2vw] lg:p-[0_2vw] text-white'>{'Vitamins'}</span>
            <span className='h-1 w-1 lg:h-2 lg:w-2 rounded-full bg-white'></span>
            <span className='text-[8px] lg:text-[12px] p-[1vw_2vw] lg:p-[0_2vw] text-white'>{'Salt'}</span>
            <span className='h-1 w-1 lg:h-2 lg:w-2 rounded-full bg-white'></span>
        ...
        <div className='fixed left-0 top-[5vh] -z-10'>
          <p className=' text-[5rem] lg:text-[14rem] text-black/5 leading-[5rem] lg:leading-[13rem]'>HYDROSHARK</p>
          <p className=' text-[5rem] lg:text-[14rem] text-black/5 leading-[5rem] lg:leading-[13rem]'>HYDROSHARK</p>
          <p className=' text-[5rem] lg:text-[14rem] text-black/5 leading-[5rem] lg:leading-[13rem]'>HYDROSHARK</p>
          <p className=' text-[5rem] lg:text-[14rem] text-black/5 leading-[5rem] lg:leading-[13rem]'>HYDROSHARK</p>
        ...
        <div disabled className=' block lg:hidden absolute left-0 z-50  h-[35vh] w-[80vw]  pointer-events-none'>
          <motion.div
            initial={{ y: '90vh' }}
            ...
            <div className='flex flex-row justify-between w-full lg:w-9/12 px-4 lg:px-8'>
              <div className='w-[22.5vw] h-[22.5vw] lg:w-[15vh] lg:h-[15vh] relative flex flex-col items-center justify-center'>
                <div className='w-[22.5vw] h-[22.5vw] lg:w-[15vh] lg:h-[15vh] animate-rotate absolute'>
                  <Image src={process.env.NEXT_PUBLIC_API_URL + '/caffeine_curved.png'} alt='caffeine_curved' fill />
                </div>
                <div className=' w-[15vw] h-[15vw] lg:w-[10vh] lg:h-[10vh] relative'>
                  <Image src={process.env.NEXT_PUBLIC_API_URL + '/logo_caffeine.png'} alt='logo_caffeine' fill />
                </div>
              </div>
              <div className='w-[22.5vw] h-[22.5vw] lg:w-[15vh] lg:h-[15vh] relative flex flex-col items-center justify-center'>
                <div className='w-[22.5vw] h-[22.5vw] lg:w-[15vh] lg:h-[15vh] animate-rotate absolute'>
                  <Image src={process.env.NEXT_PUBLIC_API_URL + '/vitamins_curved.png'} alt='vitamins_curved' fill />
                </div>
                <div className='  w-[15vw] h-[15vw] lg:w-[10vh] lg:h-[10vh] relative'>
                  <Image alt='logo_vitamins' src={process.env.NEXT_PUBLIC_API_URL + '/logo_vitamins.png'} fill />
                </div>
              </div>
              <div className='w-[22.5vw] h-[22.5vw] lg:w-[15vh] lg:h-[15vh] relative flex flex-col items-center justify-center'>
                <div className='w-[22.5vw] h-[22.5vw] lg:w-[15vh] lg:h-[15vh] animate-rotate absolute'>
                  <Image src={process.env.NEXT_PUBLIC_API_URL + '/zerosugar_curved.png'} fill alt='zerosugar_curved' />
                </div>
                <div className=' w-[15vw] h-[15vw] lg:w-[10vh] lg:h-[10vh] relative'>
                  <Image src={process.env.NEXT_PUBLIC_API_URL + '/logo_sugar.png'} fill alt='logo_sugar' />
                </div>
              </div>
            </div>
            <div className='w-full flex flex-col items-end mt-4 lg:mt-[5vh]'>
              <p className=' text-black text-xl font-semibold text-end'>Why choose Hydroshark?</p>
        ...
        >
          <div className=' h-[8vw] w-[8vw]  lg:h-[8vh] lg:w-[8vh] absolute right-[20vw] top-[10vh] animate-rotate -mt-2 '>
            <Image src={process.env.NEXT_PUBLIC_API_URL + '/asset5.png'} fill alt='asset5' />
          </div>
          ...
          <div className=' absolute right-0 -z-10 bottom-0'>
            <BackgroundRipple currentColor={flavorData[currentFlavour].id == 1 ? '#308918' : '#dfd434'} />
          </div>
          ...
          <div className='flex flex-col lg:flex-row justify-center mt-[10vh] w-full items-center'>
            <div className='flex flex-col items-center lg:items-end w-full lg:w-1/3'>
              ...
              <h2
                className={` text-[4rem] font-semibold ${
                  flavorData[currentFlavour].id == 1 ? 'text-[#308918]' : 'text-[#dfd434]'
                } `}
              >
              ...
              <div className='flex flex-col items-end'>
                ...
                <p className=' text-base text-black'>{flavorData[currentFlavour].quanity}</p>
              </div>
              <div className=' hidden lg:flex flex-col items-end mt-[10vh]'>
                <p className=' text-xs text-cyan-600'>Ingredients</p>
                <p className=' text-base text-end text-black'>{flavorData[currentFlavour].ingredients}</p>
              </div>
            </div>
            <div className='flex flex-col items-center mt-8 lg:mt-0 w-full lg:w-1/3 px-[5vw]'>
              <div className=' border-[1px] border-[#5C6262] border-dashed z-0 w-full h-[60vh] p-2 flex flex-col rounded-[2rem] items-center justify-center'>
                <div className=' flex lg:hidden w-full h-full group relative border-[1px] border-[#5C6262]/40 rounded-[3rem] pointer-events-none  '>
                  <ReplaceScene scene={flavorData[currentFlavour].id == 1 ? 'lemon' : 'mango'} orbital={false} />
                ...
                <div className=' hidden lg:flex w-full h-full group relative border-[1px] border-[#5C6262]/40 rounded-[3rem] pointer-events-none  '>
                  <ReplaceScene scene={flavorData[currentFlavour].id == 1 ? 'lemon' : 'mango'} orbital={true} />
                  {/* <Image
                    src={flavorData[currentFlavour].image}
                    fill
                    alt="flavor"
            ...
            <div className='flex flex-col items-center lg:items-start w-full mt-8 lg:mt-0 lg:w-1/3'>
              ...
              <p className=' text-black text-center lg:text-start text-xl'>{flavorData[currentFlavour].description}</p>
              ...
              <div className='flex flex-col w-9/12 items-start border-y-[1px] border-dashed border-[#5C6262] my-[5vh] lg:mt-[5vh] py-2'>
                <div className='flex flex-row w-full justify-between items-center border-b-[0.5px] border-[#5C6262]'>
                  ...
                  <div className=' flex flex-col w-1/2  items-center justify-center p-6'>
                    ...
                    <p className=' text-lg lg:text-xl text-black'>{'80 Kcal'}</p>
                  </div>
                </div>
                <div className='flex flex-row w-full justify-between items-center '>
                  ...
                  <div className=' flex flex-col w-1/2  items-center justify-center p-6'>
                    ...
                    <p className='  text-lg lg:text-xl text-black'>{'B2,B6,B12 '}</p>
                  </div>
                </div>
              </div>
            </div>
