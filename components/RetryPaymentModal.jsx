...
const RetryPaymentModal = () => {
  ...
  const { showRetryPaymentModal, setShowLoading, setShowRetryPaymentModal, setShowConfirmModal } = useStore();
  ...
  return (
    <div className={`${isOpen ? 'fixed' : 'hidden'} z-50 inset-0 flex items-center justify-center bg-black/20`}>
        ...
        {loading ? (
          ...
          <div className='w-full h-full flex flex-col '>
            <div className=' flex flex-row w-full justify-center items-baseline mt-8'>
              <p className=' text-2xl text-black font-semibold'>Retry Payment </p>
            </div>

            <div className=' bg-gray-100  py-2 px-4 rounded-md flex mt-2  flex-row w-full justify-between items-center'>
              <p className=' text-base text-black font-semibold'>Order #{showRetryPaymentModal.id}</p>
            </div>

            <div className=' flex flex-col items-start w-full mt-2'>
              <div className=' flex flex-row w-full justify-between items-baseline mt-2'>
                <p className=' text-base text-black font-semibold'>Select Payment Method </p>
              </div>
              <div className=' flex flex-col items-center w-full justify-center mt-1 bg-gray-100 rounded-md'>
                <button
                  ...
                  className={` flex flex-row justify-between w-full py-4 px-2 border-[1px] ${
                    paymentMethod == 'razorpay' ? 'border-black' : 'border-white'
                  } `}
                >
