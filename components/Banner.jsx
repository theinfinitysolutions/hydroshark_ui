          ...
          <SwiperSlide key={index}>
            <div className='w-full h-full flex flex-row items-center justify-around lg:justify-center '>
              <div className=' w-[12.5vw] h-[4vh] relative'>
                <Image src={process.env.NEXT_PUBLIC_API_URL + '/icon7.png'} fill objectFit='contain' />
              </div>
              <p className=' w-[75vw] lg:w-[50vw] text-center text-white mt-1 text-xs lg:text-sm'>{item.title}</p>
              <div className=' w-[12.5vw]  h-[4vh] relative'>
                <Image src={process.env.NEXT_PUBLIC_API_URL + '/icon6.png'} fill objectFit='contain' />
              </div>
            </div>
          </SwiperSlide>
        ))}
