...
const ProductSectionHome = () => {
  return (
    <div className=" flex flex-col items-center justify-center bg-black  overflow-hidden relative w-full h-[60vh] lg:h-full lg:pt-[5vh] lg:pb-[15vh]">
      <p className=" absolute top-[10vh] text-[5rem] lg:text-[14rem] z-40 text-white/90 leading-[5rem] lg:leading-[13rem]">
        HYDROSHARK
      </p>
      ...
      <div className="flex flex-row justify-around items-center w-full z-40 ">
        <div className=" flex flex-col items-center  w-[20%]">
          ...
          <p className=" text-white mt-1 text-sm">₹499 / 250ml</p>
        ...
        <div className=" flex flex-col items-center  w-[20%]">
          ...
          <p className=" text-blawhiteck text-sm mt-4">HYDROSHARK</p>
          <p className={` text-[1.5rem] font-semibold  text-[#308918] `}>
            {"LEMON"}
          </p>
          <p className=" text-white mt-1 text-sm">{"₹499 / 250ml X 12 "}</p>
          <button className=" flex flex-col items-center transition-all duration-200 mt-4 px-6 border-[1px] border-white py-2 bg-transparent text-white hover:bg-white hover:text-black">
            <p className=" mt-1">ADD TO CART</p>
          </button>
        </div>
