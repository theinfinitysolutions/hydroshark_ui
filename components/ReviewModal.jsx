      ...
      <div className='bg-white w-10/12 lg:w-5/12 relative overflow-y-scroll  flex flex-col items-center justify-center shadow-xl px-8 py-[5vh]'>
        ...
        {!reviewSubmitted ? (
          <div className=' w-full flex flex-col items-center'>
            <h3 className=' text-black text-2xl text-center'>Thank you for choosing Hydroshark!</h3>
            <p className='text-black text-base text-center mt-4'> Please rate your experience</p>
            <div className=' flex w-full mt-4 items-center justify-center'>
              <Rating
                emptySymbol={<MdOutlineStarOutline className='text-yellow-500 text-[3rem]' />}
                fullSymbol={<MdOutlineStar className='text-yellow-500 text-[3rem]' />}
          ...
          <div className=' w-full flex flex-col items-center'>
            <h3 className=' text-black text-2xl text-center mt-4'>Thank you for sharing your experience!</h3>
            <p className='text-black text-base '> We hope to further improve your experience</p>
